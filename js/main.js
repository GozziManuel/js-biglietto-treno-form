...
const kmAnnouncer = document.getElementById("km-announcer");
const kmAfter = document.getElementById("km-after");
// FORM FUNCTION
formVerifyer.addEventListener("submit", function (e) {
  ...
  if (isNaN(userKm) == true) {
    ...
    if (ageFinder.value === "over-65") {
      ...
      kmAnnouncer.innerText = "i chilometri del viaggio sono";
      kmAfter.innerText = userKm;
